$(function () {
    ...
    var letterHTML = '<p><strong>Halo Scot is the author of the <a href="https://haloscot.com/rift/" target="_blank">Rift Cycle</a>&mdash;a grimdark, science-fantasy series with psychological horror, mental illness, and LGBTQ+ themes&mdash;and a founding member of <a href="https://queerindie.com/" target="_blank">QueerIndie.com</a>. As a murderer of characters and destroyer of (fantasy) worlds, Halo spends too much time scheming and not enough time adulting.</strong></p><p><strong>Halo has been featured in Publishers Weekly&rsquo;s Indie Spotlight, Written Word Media&rsquo;s Bargain Booksy Content Email, and Pop Pride Week, an event hosted by ReedPop, BookCon, and New York Comic Con.</strong></p><hr class="sub" /><p>Thank you for reading, and <strong>welcome to the breach</strong>.</p><p><em>Halo Scot</em></p>';
